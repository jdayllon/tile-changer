...
(function (M) {
   ...
   M.config('tileMappgins', {
      ...
      //'tiledUrls': 'http://localhost:30080/servicios/base/gwc/service/wms?,http://localhost:30080/servicios/base/gwc/service/wms?,http://www.ideandalucia.es/geowebcache/service/wms?,http://localhost:30080/servicios/mapas/callejero/wms-tiled?,http://www.ideandalucia.es/geowebcache/service/wms?'.split(','),
      ...
      //'urls': 'http://localhost:30080/servicios/base/wms?,http://www.juntadeandalucia.es/medioambiente/mapwms/REDIAM_SPOT_Andalucia_2005?,http://www.ideandalucia.es/wms/ortofoto2010?,http://localhost:30080/servicios/mapas/callejero/wms?,http://www.ideandalucia.es/wms/ortofoto2010?'.split(',')
   });
